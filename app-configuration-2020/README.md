...
* [Example 2 config Secret](./example2-config.secret.yaml)
* [Example 2 env ConfigMap](./example2-env.configmap.yaml)
* [Example 2 env Secret](./example2-env.secret.yaml)
* [Example 2 config ConfigMap](./example2-config.configmap.yaml)
